...
def test_entity_list_keeps_missing_code_and_signal_xingtong_separate(project_root, pack):
    entities, missing = load_entities(project_root / "reference-data/会计主体清单20260907.xlsx")
...
def test_manual_extraction_expected_scopes(project_root, tmp_path):
    root = project_root / "templates/国网湖南信通公司第一批风控矩阵应用落地资料-9.11初审/国网湖南信通公司第一批风控矩阵应用落地资料-9.11初审"
