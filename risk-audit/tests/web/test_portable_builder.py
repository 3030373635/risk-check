...
def make_build_inputs(tmp_path: Path):
    ...
    write_file(repository_root / "templates/基准.xlsx")
    write_file(repository_root / "reference-data/会计主体清单20260907.xlsx")
...
def test_macos_assembly_verifies_version_architecture_and_signature(
    ...
    write_file(
        base.project_root / "risk-audit/packaging/runtime-sources.json",
        json.dumps({
            "schema_version": "1.0",
            "platforms": {
                "macos-arm64": {
