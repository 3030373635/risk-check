...
def main():
 ...
 pack=load_pack(args.root/'risk-audit/rulepacks/drafts/semantic-v1.4.0')
 model=args.root/'risk-audit/models/bge-small-zh-v1.5';cache=args.output/'vectors.sqlite3'
