...
def parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--rulepacks-root", default="审核器/rulepacks")
    ...
    vb.add_argument("--entities", default="审核/会计主体清单20260907.xlsx")
    ...
    for name in ("audit", "trial"):
        ...
        a.add_argument("--pack"); a.add_argument("--entities", default="审核/会计主体清单20260907.xlsx")
